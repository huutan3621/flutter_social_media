...
class BtnSecond extends StatelessWidget {
  ...
  const BtnSecond({
    Key? key,
    this.type = BtnSecondType.primary,
    this.title,
    this.onTap,
    this.onDoubleTap,
    this.onLongPress,
    ...
    switch (type) {
      ...
      default:
        return BoxDecoration(
          ...
          color: fillColor ?? AppColor.colorPink,
        );
    }
  }
  ...
  TextStyle buildTitleStyle() {
    switch (type) {
      case BtnSecondType.secondary:
        return tStyle.display16().w500().copyWith(
              color: AppColor.colorPink,
            );
      default:
        return tStyle.display16().w500().copyWith(color: AppColor.colorWhite);
    }
  }
}
